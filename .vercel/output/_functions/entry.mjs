...
var middlewareSecret = "bc286998-dcc4-483e-8f07-ae01dea4c291";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			OS: "Windows_NT",
			_: "C:/Users/Developer/AppData/Local/agy/bin/agy"
		})?.PROD) return {
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/quote.ts",
			"pathname": "/api/quote",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/generic_yF3jQcCM.mjs");
var _page1 = () => import("./chunks/quote_CFJj5Knc.mjs");
var pageMap = /* @__PURE__ */ new Map([["node_modules/astro/dist/assets/endpoint/generic.js", _page0], ["src/pages/api/quote.ts", _page1]]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///C:/Users/Developer/Documents/Astro/Invita-Ya/","cacheDir":"file:///C:/Users/Developer/Documents/Astro/Invita-Ya/node_modules/.astro/","outDir":"file:///C:/Users/Developer/Documents/Astro/Invita-Ya/dist/","srcDir":"file:///C:/Users/Developer/Documents/Astro/Invita-Ya/src/","publicDir":"file:///C:/Users/Developer/Documents/Astro/Invita-Ya/public/","buildClientDir":"file:///C:/Users/Developer/Documents/Astro/Invita-Ya/dist/client/","buildServerDir":"file:///C:/Users/Developer/Documents/Astro/Invita-Ya/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/quote","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/quote\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"quote","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/quote.ts","pathname":"/api/quote","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/contacto","isIndex":false,"type":"page","pattern":"^\\/contacto\\/?$","segments":[[{"content":"contacto","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contacto.astro","pathname":"/contacto","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/invitacion/[slug]","isIndex":false,"type":"page","pattern":"^\\/invitacion\\/([^/]+?)\\/?$","segments":[[{"content":"invitacion","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/invitacion/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/plantillas","isIndex":false,"type":"page","pattern":"^\\/plantillas\\/?$","segments":[[{"content":"plantillas","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/plantillas.astro","pathname":"/plantillas","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/precios","isIndex":false,"type":"page","pattern":"^\\/precios\\/?$","segments":[[{"content":"precios","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/precios.astro","pathname":"/precios","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["C:/Users/Developer/Documents/Astro/Invita-Ya/src/pages/contacto.astro",{"propagation":"none","containsHead":true}],["C:/Users/Developer/Documents/Astro/Invita-Ya/src/pages/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/Developer/Documents/Astro/Invita-Ya/src/pages/invitacion/[slug].astro",{"propagation":"none","containsHead":true}],["C:/Users/Developer/Documents/Astro/Invita-Ya/src/pages/plantillas.astro",{"propagation":"none","containsHead":true}],["C:/Users/Developer/Documents/Astro/Invita-Ya/src/pages/precios.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.BEcTYxT2.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:page:src/pages/invitacion/[slug]@_@astro":"chunks/_slug__BOgw05Kq.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:page:src/pages/contacto@_@astro":"chunks/contacto_CMSWQTfg.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_B6xzy6Kq.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","\u0000virtual:astro:page:src/pages/plantillas@_@astro":"chunks/plantillas_NNV_cONd.mjs","\u0000virtual:astro:page:src/pages/precios@_@astro":"chunks/precios_BWJBRM_g.mjs","C:/Users/Developer/Documents/Astro/Invita-Ya/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_yF3jQcCM.mjs","\u0000virtual:astro:page:src/pages/api/quote@_@ts":"chunks/quote_CFJj5Knc.mjs","C:/Users/Developer/Documents/Astro/Invita-Ya/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_X0nFMN_s.mjs","C:/Users/Developer/Documents/Astro/Invita-Ya/src/components/sections/Contact.astro?astro&type=script&index=0&lang.ts":"_astro/Contact.astro_astro_type_script_index_0_lang.COUleGi7.js","@/components/invitation/CountdownTimer":"_astro/CountdownTimer.Bk9niwZ4.js","C:/Users/Developer/Documents/Astro/Invita-Ya/src/components/layout/Navbar.astro?astro&type=script&index=0&lang.ts":"_astro/Navbar.astro_astro_type_script_index_0_lang.Dfmuf81l.js","@astrojs/react/client.js":"_astro/client.CmjTD7K3.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["C:/Users/Developer/Documents/Astro/Invita-Ya/src/components/sections/Contact.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`quote-form`),t=document.getElementById(`submit-btn`),n=document.getElementById(`btn-text`),r=document.getElementById(`btn-spinner`),i=document.getElementById(`form-alert`);e&&t&&n&&r&&i&&e.addEventListener(`submit`,async a=>{a.preventDefault(),t.disabled=!0,n.textContent=`Enviando solicitud...`,r.classList.remove(`hidden`),i.classList.add(`hidden`);let o=new FormData(e);try{let t=await fetch(`/api/quote`,{method:`POST`,body:o}),n=await t.json();t.ok&&n.success?(i.className=`mb-6 p-4 rounded-2xl text-sm font-medium bg-emerald-50 text-emerald-800 border border-emerald-200`,i.textContent=n.message,i.classList.remove(`hidden`),e.reset()):(i.className=`mb-6 p-4 rounded-2xl text-sm font-medium bg-red-50 text-red-800 border border-red-200`,i.textContent=n.error||`Ocurrió un error al enviar tu solicitud. Inténtalo de nuevo o contáctanos por WhatsApp.`,i.classList.remove(`hidden`))}catch{i.className=`mb-6 p-4 rounded-2xl text-sm font-medium bg-red-50 text-red-800 border border-red-200`,i.textContent=`Error de conexión. Por favor verifica tu red o escríbenos directamente por WhatsApp.`,i.classList.remove(`hidden`)}finally{t.disabled=!1,n.textContent=`Enviar Solicitud de Cotización`,r.classList.add(`hidden`)}});"],["C:/Users/Developer/Documents/Astro/Invita-Ya/src/components/layout/Navbar.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`mobile-menu-btn`),t=document.getElementById(`mobile-menu`),n=document.getElementById(`menu-icon-open`),r=document.getElementById(`menu-icon-close`);e&&t&&n&&r&&e.addEventListener(`click`,()=>{t.classList.contains(`hidden`)?(t.classList.remove(`hidden`),n.classList.add(`hidden`),r.classList.remove(`hidden`)):(t.classList.add(`hidden`),n.classList.remove(`hidden`),r.classList.add(`hidden`))});"]],"assets":["/favicon.ico","/favicon.svg","/_astro/client.CmjTD7K3.js","/_astro/CountdownTimer.Bk9niwZ4.js","/_astro/react.OrosJ8bI.js","/_astro/Footer.ksijx0T5.css","/contacto/index.html","/plantillas/index.html","/precios/index.html","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"y/GalU2x1TUfBRYbf6tgyxoGsOu7EKOOxcJ3xDp991I=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "bc286998-dcc4-483e-8f07-ae01dea4c291") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
